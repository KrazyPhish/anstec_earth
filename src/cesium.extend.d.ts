...
declare module "cesium" {
  ...
  export class TimelineTrack {
    constructor(interval: TimeInterval, pixexHeight: number, color: Color, backgroundColor: Color)
    interval: TimeInterval
    height: number
    color: Color
    backgroundColor: Color
    render(contex: CanvasRenderingContext2D, renderState: RenderState)
  }
}
