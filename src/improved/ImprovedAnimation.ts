...
const setShuttleRingFromMouseOrTouch = (widget: ImprovedAnimation, e: any) => {
  ...
  if (
    ...
    const canvaRect = widget._scene.canvas.getBoundingClientRect()
    const scaleX = canvaRect.width / widget._scene.canvas.width
    const scaleY = canvaRect.height / widget._scene.canvas.height
